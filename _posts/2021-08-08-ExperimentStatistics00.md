...
아직, 눈금값 오차를 고려하지 않았습니다. 위의 평균값 계산값과 $$5.02$$ 와의 차이인 $$0.00133$$ 은, 눈금값오차로 생각할 수 있는 $$0.05$$ 보다 작습니다.
...
$$5.18 \pm 0.004\mathrm{(stat.)} \pm 0.05\mathrm{(sys.)} \mathrm{~~with~} N=36 $$

보통의 경우에는, 통계적 불확도 (위의 $$\mathrm{stat.}$$)와 계통적 불확도(위의 $$\mathrm{sys.}$$) 를 합성 $$(\sqrt{0.004^2 + 0.05^2}=0.05016)$$ 하여 표기하기 때문에, 
