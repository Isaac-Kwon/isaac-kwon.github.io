...
5. (2022년 2월) 예방접종에 완료에 의한 격리 면제가 중단되었으며, 방역 교통망 (KTX 해외입국자칸, 방역택시) 또는 자차를 활용하여 귀가해야합니다.
    * KTX 해외입국자칸의 경우, 선예약이 불가능합니다.
      * 인천공항 - 광명역 지정버스를 타고 광명역에 도착한 후 KTX티켓을 구매할 때 버스 비용(12,000원)을 지불합니다.
    * 방역 택시는 해외입국자용 KTX 또는 해외입국자용 시외고속버스 하차 후 담당 지자체 보건소(버스터미널/철도역 바로 앞에 있음)에서 바로 제공하거나, 따로 예약해야합니다.
