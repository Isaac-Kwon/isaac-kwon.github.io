...
최소제곱법을 활용한 가장 맞는 직선을 구하는 방법 (피팅)에 대한 내용은 다른 포스트에서 설명하고 있습니다. <sub>([Link](/posts/trendline-basic/))</sub>
...
이론에 의해 예측된 수식의 개형이 **직선일 때** 그 계수를 구하거나, 또는 종속변수가 독립변수에 대해 **선형으로** 비례한다는 것을 보이고 싶을 때 ($$R^2$$ 통계치, $$\chi^2/\mathrm{ndf}$$ 로) 사용합니다.  일반물리실험의 보고서에서는, 데이터 간 관계를 수식으로 규명할 수 있을 시 반드시 써야합니다. 다만, 다음 경우에는 감점 요인이 될 수 있습니다.
